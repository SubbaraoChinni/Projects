...
class FloatCart extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.newProduct !== this.props.newProduct) {
      console.log('Inside nextProps.newProduct' + nextProps.newProduct)
      this.addProduct(nextProps.newProduct);
    }

    if (nextProps.productToRemove !== this.props.productToRemove) {
      console.log('Inside nextProps.productToRemove' + nextProps.productToRemove)
  ...
  changeProductQuantity = changedProduct => {
    const { cartProducts, updateCart } = this.props;
    console.log('Inside changeProductQuantity')
    const product = cartProducts.find(p => p.id === changedProduct.id);
    console.log('Inside changeProduct' + product)
  ...
  render() {
    ...
    console.log('After forming products:');
